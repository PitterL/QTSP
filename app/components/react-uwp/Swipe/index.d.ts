...
export default class Swipe extends React.Component<SwipeProps, SwipeState> {
    ...
    componentWillReceiveProps(nextProps: SwipeProps): void;
    componentWillUnmount(): void;
    updateState: (props: SwipeProps, setToState?: boolean) => void;
    setNextSlider: {
        (): void;
        funStartTime?: number;
    };
    getFocusIndex: () => number;
    swipeToIndex: (focusIndex: number) => void;
    swipeForward: () => void;
    swipeBackWord: () => void;
    getItemsLength: () => number;
    setRightFocusIndex: (focusIndex: number) => number;
    checkIsToucheEvent: (e: React.SyntheticEvent<HTMLDivElement> | React.TouchEvent<HTMLDivElement>) => boolean;
    mouseOrTouchDownHandler: (e: any) => void;
    mouseOrTouchMoveHandler: (e: any) => void;
    mouseOrTouchUpHandler: (e: any) => void;
    render(): JSX.Element;
}
