...
/*
export const makeSelectDataStrucure = () =>
  createSelector(root, state => state.get('datastruct'));
*/
export const makeSelectRsdRawFormat = () =>
  createSelector(root, state => state.get('rsdRawFormat'));
